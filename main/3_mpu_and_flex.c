    ...
    while (1) {
        ...
        // GYRO TRIGGERS
            ...
            play_mp3_file(6); last_played = 6;
                 ...
                 (gyro_x < 1000 && gyro_y < 15000 && gyro_z < 15000)) {
