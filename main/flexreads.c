...
void app_main(void) {
    ...
    while (1) {
        ...
        if (is_in_trigger_range(index) && last_played != 1) { play_mp3_file(1); last_played = 1; }
        ...
        if (gyro_x > 15000 || gyro_y > 15000 || gyro_z > 15000) {
            play_mp3_file(6); // Example: play track 6 for strong motion
